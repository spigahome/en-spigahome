jQuery(function($) {
	...
	VP_PFUI.postFormats = function($) {
		return {
			...
			quote: function() {
				$('#vp-pfui-format-link-url, #vp-pfui-format-video-fields, #vp-pfui-format-audio-fields, #vp-pfui-format-gallery-preview').hide();
	...
	// tab switch
	$(document).on('click','#vp-post-formats-ui-tabs a', function(e) {
